 ...
 */
export function inspect(bytes: Uint8Array): string;
 ...
 */
export function roundtrip(bytes: Uint8Array): Uint8Array;
...
export interface InitOutput {
    ...
    readonly roundtrip: (a: number, b: number) => [number, number, number, number];
